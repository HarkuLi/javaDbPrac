...
<head>
	...
	<title><spring:message code="signIn.text" text="Sign In" /></title>
</head>
<body>
	<!-- navigation bar -->
			...
			<form:form class="form-horizontal" modelAttribute="account_form" method="post" action="/javaDbPrac/sign_in/page" enctype="multipart/form-data">
				<div class="form-group">
					<form:label class="control-label col-md-3" path="account">
						<spring:message code="account.text" text="account" />:
					</form:label>
					<div class="col-md-9">
				...
				<div class="form-group">
					<form:label class="control-label col-md-3" path="password">
						<spring:message code="password.text" text="password" />:
					</form:label>
					<div class="col-md-9">
				...
				<button type="submit" class="btn btn-success center-block">
					<spring:message code="signIn.text" text="Sign In" />
				</button>
			</form:form>
		</div>
		<div class="panel panel-success center-block text-center">
			<span>
				<spring:message code="noAccount.text" text="No account" />?
				<a href="/javaDbPrac/sign_up/page"> <spring:message code="createAccount.text" text="Create an account" /></a>
			</span>
		</div>
	</div>
</body>
